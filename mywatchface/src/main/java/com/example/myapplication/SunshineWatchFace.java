...
public class SunshineWatchFace extends CanvasWatchFaceService {
    ...
    private class Engine extends CanvasWatchFaceService.Engine {
        ...
        Paint mTextPaint, mTextPaintThin;
        boolean mAmbient;
        Calendar mCalendar;
        ...
        public void onCreate(SurfaceHolder holder) {
            ...
            mTextPaintThin = new Paint();
            mTextPaintThin = createTextPaint(resources.getColor(R.color.digital_text_small));
        ...
        public void onApplyWindowInsets(WindowInsets insets) {
            ...
            mTextPaintThin.setTextSize(resources.getDimension(R.dimen.digital_text_size_small));
        }
